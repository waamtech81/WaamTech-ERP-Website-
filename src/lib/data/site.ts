...
export const pricingPlans: PricingPlan[] = [
  {
    id: "starter",
    name: "Starter",
    description: "Solo operators and small shops going digital.",
    monthlyPrice: 9,
    yearlyPrice: 7,
    originalMonthlyPrice: 19,
    originalYearlyPrice: 15,
    launchDiscount: 50,
    cta: "Start free trial",
    href: "/signup?plan=starter",
    usersIncluded: 1,
    usersNote: "1 user included",
    modules: ["Inventory", "POS", "Sales & Invoicing", "Finance essentials"],
    features: [
      "1 user included",
      "Inventory, POS, Sales & Finance essentials",
      "Responsive web + native PWA app",
  ...
  },
  {
    id: "business",
    name: "Business",
    description: "Growing & multi-branch teams with CRM, warehouse & full AI.",
    monthlyPrice: 39,
    yearlyPrice: 29,
    originalMonthlyPrice: 79,
    originalYearlyPrice: 59,
    launchDiscount: 50,
    popular: true,
    cta: "Start free trial",
    href: "/signup?plan=business",
    usersIncluded: 10,
    usersNote: "10 users included · extra users on demand",
    modules: [
    ...
    features: [
      "10 users included · extra users on demand",
      "Purchasing, CRM, Warehouse, HR & Manufacturing",
      "Full AI: Assistant, Document OCR, insights & recommendations",
      "Responsive web + native PWA app",
      "Multi-company, API, WhatsApp & Maps",
  ...
  },
  {
    id: "lifetime",
    name: "Lifetime",
    description: "Pay once — all modules & AI, forever.",
    monthlyPrice: null,
    yearlyPrice: null,
    lifetimePrice: 4999,
    ...
    href: "/contact?intent=lifetime",
    usersIncluded: 25,
    usersNote: "25 users included · extra users on demand",
    modules: [
      "All ERP modules forever",
      "Full AI Workspace",
      "Industry & specialty packs",
      "Lifetime updates & patches",
    ],
    features: [
      "25 users included · extra users on demand",
      "All modules + full AI Workspace forever",
      "Responsive web + native PWA app",
  ...
  },
  {
    id: "enterprise",
    name: "Enterprise",
    description: "Own server, whitelabel & custom scale.",
    monthlyPrice: null,
    yearlyPrice: null,
    cta: "Contact for quote",
    href: "/contact?intent=enterprise",
    usersIncluded: "unlimited",
    usersNote: "Unlimited users",
    modules: [
      "Everything in Business / Lifetime",
      "Custom module mix",
      "Whitelabel & SSO",
      "Own cloud or on-premise",
    ],
    features: [
      "Unlimited users",
      "Own cloud / local server & whitelabel",
      "Responsive web + native PWA app",
      "Full AI Workspace + custom SLAs",
      "SSO, training & dedicated infrastructure",
    ],
  },
];
...
export const comparisonFeatures = [
  { name: "Users included", starter: "1", business: "10", enterprise: "Unlimited", lifetime: "25" },
  { name: "Extra users on demand", starter: false, business: true, enterprise: true, lifetime: true },
  { name: "Inventory", starter: true, business: true, enterprise: true, lifetime: true },
  { name: "POS", starter: true, business: true, enterprise: true, lifetime: true },
  { name: "Sales & Invoicing", starter: true, business: true, enterprise: true, lifetime: true },
  { name: "Finance", starter: "Essentials", business: true, enterprise: true, lifetime: true },
  { name: "Purchasing", starter: false, business: true, enterprise: true, lifetime: true },
  { name: "CRM", starter: false, business: true, enterprise: true, lifetime: true },
  { name: "Warehouse & Logistics", starter: false, business: true, enterprise: true, lifetime: true },
  { name: "HR & Payroll", starter: false, business: true, enterprise: true, lifetime: true },
  { name: "Documents", starter: false, business: true, enterprise: true, lifetime: true },
  { name: "Manufacturing", starter: false, business: true, enterprise: true, lifetime: true },
  { name: "Service & Projects", starter: false, business: true, enterprise: true, lifetime: true },
  { name: "AI Assistant", starter: false, business: true, enterprise: true, lifetime: true },
  { name: "Document AI / OCR", starter: false, business: true, enterprise: true, lifetime: true },
  { name: "AI insights & recommendations", starter: false, business: true, enterprise: true, lifetime: true },
  { name: "Responsive web + native PWA app", starter: true, business: true, enterprise: true, lifetime: true },
  { name: "Multi-company", starter: false, business: true, enterprise: true, lifetime: true },
  { name: "API access", starter: false, business: true, enterprise: true, lifetime: true },
  { name: "WhatsApp & Maps", starter: false, business: true, enterprise: true, lifetime: true },
  { name: "Own server / Local", starter: false, business: false, enterprise: true, lifetime: false },
  { name: "Whitelabel", starter: false, business: false, enterprise: true, lifetime: false },
  { name: "Lifetime updates", starter: false, business: false, enterprise: false, lifetime: true },
  { name: "SSO", starter: false, business: false, enterprise: true, lifetime: false },
  { name: "Dedicated success manager", starter: false, business: true, enterprise: true, lifetime: true },
];
