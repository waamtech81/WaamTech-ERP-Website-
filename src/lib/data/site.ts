...
export const siteConfig = {
  ...
  description:
    "WAAMTO is a modular Enterprise ERP Platform by WaamTech for Inventory, POS, Sales, Purchasing, Finance, CRM, HR, and Manufacturing — configured across 17 industries and 100+ business categories.",
...
export const pricingPlans: PricingPlan[] = [
  {
    id: "starter",
    name: "Starter",
    description: "Perfect for small shops & startups getting digital.",
    monthlyPrice: 9,
    yearlyPrice: 7,
    ...
    features: [
      "Up to 3 users",
      "Core ERP + Inventory",
      "Responsive web (all devices)",
      "Invoicing & POS basics",
      "Standard reports",
      "Email support",
    ],
  },
  {
    id: "professional",
    name: "Professional",
    description: "Full operations for growing businesses.",
    monthlyPrice: 19,
    yearlyPrice: 15,
    originalMonthlyPrice: 39,
    originalYearlyPrice: 31,
    launchDiscount: 50,
    popular: true,
    cta: "Start free trial",
    ...
    features: [
      ...
      "Native mobile app (profile-based)",
      "CRM, POS & Warehouse",
      "HR & Payroll ready",
  ...
  },
  {
    id: "business",
    name: "Business",
    description: "Multi-branch teams scaling across locations.",
    monthlyPrice: 39,
    yearlyPrice: 29,
    ...
    features: [
      ...
      "Native mobile for all field roles",
  ...
  },
  {
    id: "enterprise",
    name: "Enterprise",
    description: "Own server, whitelabel & on-premise options.",
    monthlyPrice: null,
    yearlyPrice: null,
    ...
    features: [
      "Unlimited users",
      "Custom mobile / branded app options",
...
export const comparisonFeatures = [
  { name: "Users included", starter: "3", professional: "10", business: "50", enterprise: "Unlimited", lifetime: "25" },
  { name: "Core ERP", starter: true, professional: true, business: true, enterprise: true, lifetime: true },
  { name: "Responsive web (all devices)", starter: true, professional: true, business: true, enterprise: true, lifetime: true },
  { name: "Native mobile app", starter: "Profile-based", professional: true, business: true, enterprise: true, lifetime: true },
  { name: "Inventory & Invoicing", starter: true, professional: true, business: true, enterprise: true, lifetime: true },
  { name: "CRM", starter: false, professional: true, business: true, enterprise: true, lifetime: true },
  { name: "POS", starter: true, professional: true, business: true, enterprise: true, lifetime: true },
  { name: "Warehouse", starter: false, professional: true, business: true, enterprise: true, lifetime: true },
  { name: "Multi-company", starter: false, professional: false, business: true, enterprise: true, lifetime: false },
  { name: "API access", starter: false, professional: false, business: true, enterprise: true, lifetime: true },
  { name: "WhatsApp & Maps", starter: false, professional: false, business: true, enterprise: true, lifetime: true },
  { name: "Own server / Local", starter: false, professional: false, business: false, enterprise: true, lifetime: false },
  { name: "Whitelabel", starter: false, professional: false, business: false, enterprise: true, lifetime: false },
  { name: "Lifetime updates", starter: false, professional: false, business: false, enterprise: false, lifetime: true },
  { name: "SSO", starter: false, professional: false, business: false, enterprise: true, lifetime: false },
  { name: "Dedicated success manager", starter: false, professional: false, business: true, enterprise: true, lifetime: true },
];
